...
export class ClientAuthGuard implements CanActivate {
  excludedRequests = [
    ...
    '/v1/api/course/open/search',
    '/v1/api/course/open/category',
    '/v1/api/course/open/popular-categories',
    '/v1/api/course/open/by-id',
    '/v1/api/course/open/reviews/course/by-id',
    '/v1/api/course/open/category/by-id',
  ];
  public constructor(
